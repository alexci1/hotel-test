...
public class DescuentoController {
    ...
    public CollectionModel<DescuentoResponse> findByValidoDesde(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate validoDesde) {
    ...
    public CollectionModel<DescuentoResponse> findByValidoHasta(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate validoHasta) {
    ...
    @PutMapping("/{id}")
    public DescuentoResponse update(@PathVariable Long id, @Valid @RequestBody DescuentoRequest request) {
