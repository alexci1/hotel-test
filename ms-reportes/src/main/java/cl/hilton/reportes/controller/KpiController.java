...
public class KpiController {
    ...
    public CollectionModel<KpiResponse> findByActualizadoEn(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate actualizadoEn) {
    ...
    @PutMapping("/{id}")
    public KpiResponse update(@PathVariable Long id, @Valid @RequestBody KpiRequest request) {
