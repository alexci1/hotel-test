...
/**
* Genera un número de habitación ficticio para las pruebas.
*/
...
/**
* Genera un código ficticio de tipo de habitación.
*/
...
tipoHabitacion.setId(faker.number().randomNumber());
...
// Si no existe la habitación, no debe convertir a response.
