...
CREATE TABLE proj_huesped (
    ...
    numero_habitacion  VARCHAR(10),                        -- habitación actual (puede ser NULL si es externo)
...
CREATE TABLE mesa (
    ...
    numero_mesa  VARCHAR(10) NOT NULL UNIQUE,              -- clave de negocio: M01, M02, TERRAZA-1...
...
CREATE TABLE pedido (
    id              SERIAL        PRIMARY KEY,
    numero_pedido   VARCHAR(20)   NOT NULL UNIQUE,          -- ej: PED-20240601-001
    numero_mesa     VARCHAR(10)
        REFERENCES mesa(numero_mesa) ON UPDATE CASCADE,     -- NULL si es room service
    email_huesped   VARCHAR(120)
        REFERENCES proj_huesped(email),                     -- NULL si es cliente externo
...
-- Ítems de cada pedido (productos del menú)
CREATE TABLE item_pedido (
    ...
    observacion     TEXT                                     -- ej: 'sin cebolla', 'término medio'
);
...
INSERT INTO proj_huesped (email, nombre_completo, numero_habitacion) VALUES
    ...
    ('borde@test.com',       'Usuario Borde',        NULL);  -- caso borde: sin habitación

INSERT INTO mesa (numero_mesa, capacidad, zona, disponible) VALUES
    ('M01', 4,  'SALON',    TRUE),
    ('M02', 2,  'SALON',    FALSE),    -- caso borde: mesa ocupada
    ('M03', 8,  'PRIVADO',  TRUE),
    ('T01', 4,  'TERRAZA',  TRUE),
    ('B01', 1,  'BARRA',    TRUE),
    ('RS',  1,  'ROOM_SERVICE', TRUE); -- mesa virtual para room service
...
INSERT INTO pedido (numero_pedido, numero_mesa, email_huesped, estado, total_usd) VALUES
    ...
    ('PED-20240602-001',  NULL,  'ana.garcia@email.com', 'ABIERTO',   22.00), -- caso borde: room service
    ('PED-20240602-002', 'T01',   NULL,                  'ABIERTO',   15.00), -- caso borde: cliente externo
    ('PED-20240602-003', 'M01',  'borde@test.com',       'CANCELADO',  0.00); -- caso borde: cancelado
...
INSERT INTO item_pedido (numero_pedido, nombre_producto, cantidad, precio_unit_usd, observacion) VALUES
    ...
    ('PED-20240602-001', 'Desayuno completo',   1, 22.00, 'Subir a hab 101 antes de las 8am'), -- caso borde: room service
