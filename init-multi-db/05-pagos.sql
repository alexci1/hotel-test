...
-- Factura por estancia (se genera al hacer checkout)
...
-- Pagos individuales que abonan a una factura
CREATE TABLE pago (
    id              SERIAL        PRIMARY KEY,
    ...
    referencia      VARCHAR(80),                           -- número de transacción externo
...
-- Cargos adicionales a la factura (minibar, restaurante, daños, etc.)
CREATE TABLE cargo (
    id              SERIAL        PRIMARY KEY,
    numero_factura  VARCHAR(20)   NOT NULL
        REFERENCES factura(numero_factura) ON UPDATE CASCADE,
...
INSERT INTO factura (numero_factura, codigo_reserva, email_huesped, total_usd, estado) VALUES
    ('FAC-2024-00001', 'RES-20240601-0001', 'ana.garcia@email.com', 380.00, 'PAGADA'),
    ('FAC-2024-00002', 'RES-20240615-0002', 'carlos.m@email.com',   650.00, 'PARCIAL'),
    ('FAC-2024-00003', 'RES-20240701-0003', 'borde@test.com',        90.00, 'PENDIENTE'),  -- caso borde: 1 noche
    ('FAC-2024-00004', 'RES-20240801-0004', 'empresa@corp.com',       0.00, 'ANULADA');    -- caso borde: anulada

INSERT INTO pago (numero_factura, monto_usd, metodo, referencia) VALUES
    ('FAC-2024-00001', 380.00, 'TARJETA_CREDITO', 'TXN-VISA-001234'),
    ('FAC-2024-00002', 300.00, 'TRANSFERENCIA',   'TRF-BAN-005678'),
    ('FAC-2024-00002',  50.00, 'EFECTIVO',         NULL);              -- caso borde: pago parcial en efectivo

INSERT INTO cargo (numero_factura, concepto, monto_usd, origen) VALUES
    ('FAC-2024-00001',  'Cena gourmet noche del 02-jun',   45.00, 'RESTAURANTE'),
    ('FAC-2024-00001',  'Consumo minibar habitación 101',   12.50, 'MINIBAR'),
    ('FAC-2024-00002',  'Daño en silla de escritorio',      80.00, 'DANO'),        -- caso borde: cargo por daño
    ('FAC-2024-00003',  'Desayuno buffet',                  18.00, 'RESTAURANTE');
